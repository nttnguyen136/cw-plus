...
WASM_PATH="./artifacts/"
WASM_FILE="cw20_base.wasm" #normal
...
INIT_MSG='{
"name": "Serenity Aura Network Token",
"symbol": "SAURA",
"decimals": 6,
"initial_balances": [],
"mint": { "minter": "aura1h6r78trkk2ewrry7s3lclrqu9a22ca3hpmyqfu" },
"marketing": { "description": "Coin gives you the joint benefits of open blockchain technology and traditional currency by converting your cash into a stable digital currency equivalent.","logo": {"url": "https://nft-ipfs.s3.amazonaws.com/assets/imgs/icons/color/aura.svg"}, "marketing":"aura1h6r78trkk2ewrry7s3lclrqu9a22ca3hpmyqfu"}
}'
